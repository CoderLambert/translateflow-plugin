...
.tf-quick-trigger {
  ...
  font-weight: 750;
  opacity: .62;
  transition: opacity var(--tf-transition-fast), transform var(--tf-transition-fast), border-color var(--tf-transition);
}
...
.tf-quick-trigger[data-state="completed"] { border-color: var(--tf-success); }
